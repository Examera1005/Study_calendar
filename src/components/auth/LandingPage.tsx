      ...
      <div className="lp-hero-visual">
        <div className="lp-floating-card lp-fc-1">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.82rem" }}>
              <span style={{ fontWeight: 600 }}>🧮 {t.landingPage.mockCalculusExam}</span>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.82rem", marginTop: 4 }}>
              <span style={{ fontWeight: 600 }}>🧪 {t.landingPage.mockChemistryExam}</span>
        ...
        <div className="lp-floating-card lp-fc-2">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, fontSize: "0.82rem" }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontWeight: 600, color: "#fff" }}>Alice ({t.landingPage.mockFriendStatus})</div>
              <div style={{ fontSize: "0.75rem", color: "#10b981" }}>
                {t.landingPage.mockFriendActivity}
              </div>
            </div>
            <span style={{ fontSize: "1.1rem" }}>⚡ 5{t.landingPage.mockStreakShortUnit}</span>
          </div>
        </div>
        ...
        <div className="lp-floating-card lp-fc-3">
          ...
          <div className="lp-fc-streak">
            <span className="lp-streak-num">05 <span>{t.landingPage.daysUnit}</span></span>
    ...
    <section id="features" className="lp-features">
      ...
      <div className="lp-features-grid">
        <TiltCard className="lp-feat-card" neonColor="#3b82f6">
          ...
          <p>
            {t.landingPage.structuredTimetableDesc}
          </p>
        </TiltCard>
        ...
        <TiltCard className="lp-feat-card" neonColor="#10b981">
          ...
          <p>
            {t.landingPage.encryptedChatDesc}
          </p>
        </TiltCard>
...
function LandingFooter({ t, onShowLegal }: LandingFooterProps) {
  return (
    <footer className="lp-footer">
      <div suppressHydrationWarning>© {new Date().getFullYear()} {t.auth.copyright}. {t.landingPage.footerText}</div>
      <div className="lp-footer-links">
        ...
        <button 
          ...
          onClick={() => { playSynthSound("click"); onShowLegal("privacy"); }}
        >
        ...
        <button 
          ...
          className="lp-footer-link" 
          style={{ background: "none", border: "none", font: "inherit", cursor: "pointer", padding: 0 }}
          onClick={() => { playSynthSound("click"); onShowLegal("terms"); }}
        >
          {t.settings.termsBtn}
        </button>
        <span style={{ color: "rgba(255,255,255,0.05)" }}>•</span>
        <span style={{ color: "#71717a" }}>
          {t.landingPage.footerConvex}
        </span>
      </div>
    </footer>
  );
