...
export function AddTaskModal({ date, subjects, onClose, onCreated }: {
  date: string;
...
export function AddEventModal({ date, onClose, onCreated }: {
  date: string;
  onClose: () => void;
  onCreated?: () => void;
}) {
...
export function AddLogModal({ date, subjects, onClose, onCreated }: {
  date: string;
  subjects: Doc<"subjects">[] | undefined;
  onClose: () => void;
  onCreated?: () => void;
...
export function EditTaskModal({ task, subjects, onClose, onSaved }: {
  task: Doc<"tasks">;
  subjects: Doc<"subjects">[] | undefined;
  onClose: () => void;
  onSaved?: () => void;
...
export function EditLogModal({ log, subjects, onClose, onSaved }: {
  log: Doc<"dailyLogs">;
  subjects: Doc<"subjects">[] | undefined;
  onClose: () => void;
  onSaved?: () => void;
