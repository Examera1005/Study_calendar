...
interface DashboardExamsCardProps {
	// biome-ignore lint/suspicious/noExplicitAny: Dynamic Convex API / third-party type
	upcomingExams: any[] | undefined;
	setView: (v: View) => void;
	// biome-ignore lint/suspicious/noExplicitAny: Dynamic Convex API / third-party type
...
function DashboardExamsCard({
	upcomingExams,
	setView,
	getSubject,
	t,
	dateLocale,
}: DashboardExamsCardProps) {
	return (
		<div className="card">
...
interface DashboardGeneralTasksCardProps {
	// biome-ignore lint/suspicious/noExplicitAny: Dynamic Convex API / third-party type
	generalTasks: any[] | undefined;
	setView: (v: View) => void;
	generalIncomplete: number;
...
function DashboardGeneralTasksCard({
	generalTasks,
	setView,
	generalIncomplete,
	t,
}: DashboardGeneralTasksCardProps) {
	return (
		<div className="card">
			<div className="card-header">
				<h3 style={{ display: "flex", alignItems: "center", gap: 8 }}>
...
interface DashboardStudyLogCardProps {
	// biome-ignore lint/suspicious/noExplicitAny: Dynamic Convex API / third-party type
	todayLogs: any[] | undefined;
	setView: (v: View) => void;
	setSelectedDate: (d: string) => void;
...
function DashboardStudyLogCard({
	todayLogs,
	setView,
	setSelectedDate,
	activeDate,
...
interface DashboardSubjectDistributionCardProps {
	// biome-ignore lint/suspicious/noExplicitAny: Dynamic Convex API / third-party type
	subjectBreakdown: any[];
	// biome-ignore lint/suspicious/noExplicitAny: translations object
	t: any;
...
function DashboardSubjectDistributionCard({
	subjectBreakdown,
	t,
}: DashboardSubjectDistributionCardProps) {
	return (
		<div className="card">
			<div className="card-header">
				<h3 style={{ display: "flex", alignItems: "center", gap: 8 }}>
...
export function DashboardCardGrid({
	...
	return (
		<div className="card-grid">
			...
			<DashboardSubjectDistributionCard
