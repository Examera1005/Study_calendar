...
export const translations: Record<"en" | "fr", TranslationSchema> = {
	en: {
		...
		friends: {
			...
			guildCardDesc:
				"Study together, share tips, and motivate each other to succeed.",
			setupProfileTitle: "Setup Friends Profile",
			setupProfileDesc:
				"Choose a handle to enable chat, leaderboard, and study circles.",
			...
			keysRegenerated:
				"Encryption keys regenerated. Messages from previous sessions may not be decryptable.",
		...
		subjects: {
			...
			noSubjectsYet:
				"No subjects created yet. Setup subjects to tag your exams, tasks and study logs.",
		...
		settings: {
			...
			themeDesc:
				"Switch between light and dark themes to optimize viewing comfort.",
			themeLight: "Light Mode",
			themeDark: "Dark Mode",
			widgetTitle: "⏱️ Float Timer Widget",
			widgetDesc:
				"Configure screen position and scaling for the persistent stopwatch widget.",
			...
			profileHandleDesc:
				"Update your public handle to customize how friends see you.",
			blockedUsersTitle: "🚫 Blocked Users Management",
			blockedUsersDesc:
				"Manage users you have blocked from messaging or adding you.",
			...
			blockedUsersBlockSuccess: (username) =>
				`Successfully blocked ${username}`,
			...
			themeCustomDesc: (mode) =>
				`Fine-tune colors for ${mode === "dark" ? "Dark" : "Light"} Mode. Changes apply instantly.`,
		...
		pomodoro: {
			...
			resetMinuterPrompt:
				"Would you like to reset the current timer to apply this shortcut?",
			keyboardShortcutsTitle: "💡 Tips",
			keyboardShortcutsDesc:
				"Use intervals like 25/5 or 50/10 to train focus endurance. If you stop the Work timer, you can log the logged minutes directly into your Daily Log!",
			goalLabel: "Goal",
		...
		analytics: {
			...
			linkSubjectsPrompt:
				"Please tag your study sessions with subjects to see detailed distributions.",
		...
		landingPage: {
			...
			daysUnit: "Days",
			featuresIntro:
				"Ditch cluttered text docs and chaotic timers. Keep all aspects of your academic routine in one clean dashboard.",
			structuredTimetableTitle: "Structured Timetable",
			structuredTimetableDesc:
			...
			playgroundDesc:
				"Interact with these fully functional mock blocks to see how Study Calendar keeps you on track, directly from the landing page.",
			...
			feature1Desc:
				"Log study sessions and set tasks linked directly to your exam calendars.",
			feature2Title: "Focus Timers",
			feature2Desc:
				"Use stopwatches and customized Pomodoro cycles to train focus endurance.",
			feature3Title: "Social Motivation",
			feature3Desc:
				"Share study leaderboards, chat with peers, and compare schedules.",
	...
	fr: {
		...
		sidebar: {
			...
			subjects: "Matières",
			settings: "Paramètres",
			subtitle: "Organisez-vous, réussissez !",
		...
		dashboard: {
			...
			hoverColumnsDesc:
				"Survolez les colonnes pour voir des jours spécifiques.",
		...
		calendar: {
			...
			confirmDeleteLog:
				"Êtes-vous sûr de vouloir supprimer cette session d'étude ?",
			addTaskBtn: "+ Tâche",
		...
		exams: {
			...
			createSubjectWarning:
				"⚠️ Créez d'abord une matière dans les Paramètres avant d'ajouter des examens.",
			noExamsYet:
				"Pas encore d'examens. Ajoutez votre premier examen ci-dessus !",
			passed: "Passé",
			today: "Aujourd'hui",
			tomorrow: "Demain",
		...
		tasks: {
			...
			completedCount: (completed, total) =>
				`${completed}/${total} complétée(s)`,
			dailyTab: "Quotidien",
			generalTab: "Général",
			doneTab: "Terminé",
			generalTasksDesc:
				"Ces tâches ne sont pas liées à un jour spécifique : votre liste de choses à faire en cours.",
			completedTasksDesc:
				"Vos tâches complétées pour le jour sélectionné et le carnet général en cours.",
		...
		friends: {
			...
			guildCardDesc:
				"Étudiez ensemble, partagez vos conseils et motivez-vous les uns les autres.",
			setupProfileTitle: "Activer le profil d'Amis",
			setupProfileDesc:
				"Choisissez un nom d'utilisateur pour activer le chat, le classement et les cercles d'études.",
			...
			setupProfileError:
				"Impossible de créer le profil. Choisissez un nom d'utilisateur unique.",
			friendRequestSent: (username) => `Demande d'ami envoyée à ${username} !`,
			confirmBlockUser: (username) =>
				`Êtes-vous sûr de vouloir bloquer ${username} ?`,
			keysRegenerated:
				"Clés de chiffrement régénérées. Les messages des sessions précédentes peuvent ne pas être déchiffrables.",
			loggedInAs: (username) => `Connecté en tant que ${username}`,
			onlyLettersAllowed:
				"Seuls les lettres, chiffres et underscores sont autorisés. Nous préfixerons automatiquement avec '@'.",
			e2eTitle: "🔒 Messagerie chiffrée de bout en bout",
			e2eDesc:
				"La création d'un profil génère une paire de clés RSA 2048 bits sécurisée dans votre navigateur. Tous les messages de discussion sont scellés cryptographiquement localement avant d'être envoyés.",
			generatingKeys: "Génération des clés de chiffrement...",
			leaderboardTitle: "Classement hebdomadaire d'études",
			leaderboardDesc:
				"Le classement est basé sur le total des heures d'étude enregistrées au cours des 7 derniers jours.",
			youLabel: "Vous",
			noSubjectsLeaderboard: "Aucune matière étudiée cette semaine",
			preparingFor: "Prépare :",
			noGuildMembers:
				"Aucun membre de guilde trouvé. Ajoutez des amis pour commencer à comparer !",
			...
			searchFriendsDesc:
				"Recherchez d'autres utilisateurs en tapant leur nom d'utilisateur.",
			...
			acceptedFriendsDesc:
				"Vos amis peuvent comparer leurs sessions avec vous sur le classement, envoyer des messages sécurisés et vous permettre d'importer leurs examens.",
		...
		subjects: {
			...
			noSubjectsYet:
				"Aucune matière créée pour le moment. Configurez des matières pour organiser vos examens, tâches et sessions d'étude.",
		...
		settings: {
			...
			accountInfoDesc:
				"Détails associés à votre session Study Calendar active.",
			emailLabel: "Adresse e-mail",
			notSet: "Non définie",
			themeTitle: "🎨 Thème de l'application",
			themeDesc:
				"Basculez entre le mode clair et sombre pour optimiser le confort visuel.",
			themeLight: "Mode Clair",
			themeDark: "Mode Sombre",
			widgetTitle: "⏱️ Widget de minuteur flottant",
			widgetDesc:
				"Configurez la position à l'écran et la taille du chronomètre persistant.",
			...
			profileHandleDesc:
				"Mettez à jour votre nom public pour personnaliser l'affichage auprès de vos amis.",
			blockedUsersTitle: "🚫 Gestion des utilisateurs bloqués",
			blockedUsersDesc:
				"Gérez les utilisateurs que vous avez bloqués de votre messagerie.",
			...
			profileHandleMinChars:
				"Le nom d'utilisateur doit faire au moins 3 caractères.",
			profileHandleInvalidChars:
				"Seuls les lettres, chiffres et underscores (_) sont autorisés.",
			...
			profileHandleSetupRequired:
				"Veuillez activer votre profil dans l'onglet Amis pour configurer votre nom d'utilisateur.",
			...
			themeCustomDesc: (mode) =>
				`Ajustez les couleurs du mode ${mode === "dark" ? "Sombre" : "Clair"}. Appliqué instantanément.`,
		...
		pomodoro: {
			title: "Pomodoro",
			subtitle:
				"Concentration, pause, répétez. Optimisez vos intervalles de travail.",
			readyStatus: "Prêt",
			studyState: "💻 Étude",
			breakState: "☕ Pause",
			...
			resetMinuterPrompt:
				"Voulez-vous réinitialiser le minuteur actuel pour appliquer ce raccourci ?",
			keyboardShortcutsTitle: "💡 Conseils",
			keyboardShortcutsDesc:
				"Utilisez des intervalles de 25/5 ou 50/10 pour entraîner votre endurance de concentration. Lorsque vous arrêtez le minuteur d'Étude, vous pouvez enregistrer directement le temps accumulé dans votre Journal quotidien !",
			goalLabel: "Objectif",
		...
		analytics: {
			...
			linkSubjectsPrompt:
				"Veuillez lier des matières à vos sessions d'études pour voir les détails par matière.",
		...
		landingPage: {
			...
			daysUnit: "Jours",
			featuresIntro:
				"Oubliez les documents désorganisés et les minuteurs chaotiques. Regroupez votre routine académique dans un tableau de bord épuré.",
			...
			playgroundDesc:
				"Interagissez avec ces blocs de démonstration fonctionnels pour voir comment Study Calendar vous aide à rester sur la bonne voie.",
			...
			demoChecklistDesc:
				"Cochez des tâches pour mettre à jour votre barre de progression. Satisfaction garantie avec des micro-animations subtiles.",
			checklistTasks: [
			...
			pomodoroDesc:
				"Démarrez la session de focus. Le compte à rebours de 25 minutes est accéléré pour se terminer en 25 secondes pour simuler la synchronisation.",
			...
			streakDesc:
				"Les séries renforcent la discipline. Testez l'enregistrement d'une session pour incrémenter votre série et déverrouiller des badges.",
			streakStatus: "Statut des Séries",
			streakLabel: "Série :",
			streakBadgeUnlocked: "🏆 Déverrouillé : Champion Académique (5j)",
			streakNextBadge:
				"Loguez 1 session de plus pour déverrouiller le prochain badge",
			...
			feature1Desc:
				"Enregistrez vos sessions d'étude et liez vos tâches directement au calendrier de vos examens.",
			feature2Title: "Minuteurs de concentration",
			feature2Desc:
				"Utilisez des chronomètres et des cycles Pomodoro pour augmenter votre endurance intellectuelle.",
			feature3Title: "Motivation sociale",
			feature3Desc:
				"Partagez vos statistiques dans un classement d'amis et discutez en direct.",
		...
		auth: {
			...
			resetPasswordSubtitle:
				"Entrez votre e-mail pour demander un code de réinitialisation",
